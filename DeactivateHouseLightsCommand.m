//
//  DeactivateHouseLightsCommand.m
//  Shion
//
...
#import "DeactivateHouseLightsCommand.h"

#import "House.h"

@implementation DeactivateHouseLightsCommand
...
- (NSDictionary *) execute
{
	...
	if (device != nil)
	{
		...
		if ([device isKindOfClass:[House class]])
		{
			...
			[house deactivateLights];
			
			string = [NSString stringWithFormat:@"Deactivating all lights in %@...", [device name]];
